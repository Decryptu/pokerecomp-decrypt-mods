...
| --- | --- | --- | --- |
| <img src="docs/icons/voxel3d.png" alt="" width="64" height="64"> | [`voxel3d`](mods/voxel3d/) | 0.6.8 | Draws the overworld in 3D, built from the cartridge's own tiles. Sky colours follow the clock, water is animated, and you can move the camera. Battles happen on the map you were standing on. Menus stay 2D and pixel-perfect. |
...
| <img src="docs/icons/follower.png" alt="" width="64" height="64"> | [`follower`](mods/follower/) | 0.3.2 | One of your Pokemon walks behind you. Pick which one from its party menu, choose whether it stays out on a bike or on water, and put it away with one key. Face it and press A to pet it. It can also pick up hidden items. |
| <img src="docs/icons/overworld_encounters.png" alt="" width="64" height="64"> | [`overworld_encounters`](mods/overworld_encounters/) | 0.3.0 | Wild Pokemon walk around on the map instead of appearing during random steps. Up to sixteen per map, taken from that map's own encounter table. Shinies are visible before the battle, and Pokemon with very high DVs glow gold. |
...
| <img src="docs/icons/quality_of_life.png" alt="" width="64" height="64"> | [`quality_of_life`](mods/quality_of_life/) | 0.1.2 | Seven conveniences, each with its own switch and all off by default: field moves without a Pokemon that knows them, Repel renewal, EXP from catches, PC in the start menu, type effectiveness hints, stat stages and a weather indicator. |
| <img src="docs/icons/shiny_charm.png" alt="" width="64" height="64"> | [`shiny_charm`](mods/shiny_charm/) | 0.1.0 | Complete the Pokedex, get your diploma from the GAME designer in Celadon, and he hands you a Shiny Charm. While it is in your bag, wild Pokemon are three times more likely to be shiny. |
