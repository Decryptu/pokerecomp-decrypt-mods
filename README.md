...
| [`follower`](mods/follower/) | 0.1.0 | One of your Pokemon out of its ball, walking the cell you just left, drawn with the cartridge's own party icon for its species. Pick the slot, whether it stays out on a bike and on the water, and put it away with one press. Not released yet: it is waiting on one host seam, named in its own README. |
