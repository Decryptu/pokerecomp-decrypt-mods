...
| <img src="docs/icons/quality_of_life.png" alt="" width="64" height="64"> | [`quality_of_life`](mods/quality_of_life/) | 0.1.5 | Nine conveniences, each with its own setting and none on until you turn it on: field moves without a Pokemon that knows them, Repel renewal, EXP from catches, PC in the start menu, running at bike speed while B is held, an EXP rate from x0.5 to x4, type effectiveness hints, stat stages and a weather indicator. |
