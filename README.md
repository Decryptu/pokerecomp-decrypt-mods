...
| [`randomizer`](mods/randomizer/) | 0.1.0 | A run generated from a four-digit seed: base stats, types, movesets, evolutions, move power and accuracy, and every trainer's team. The same seed on the same cartridge is the same game, on anyone's machine. Each of the six is its own setting. |
