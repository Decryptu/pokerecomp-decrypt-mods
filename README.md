...
| <img src="docs/icons/overworld_encounters.png" alt="" width="64" height="64"> | [`overworld_encounters`](mods/overworld_encounters/) | 0.2.1 | A bounded population of wild Pokemon roaming where random grass, cave and surf encounters used to be, up to sixteen a map for a screen that shows the whole of one. Shiny Pokemon are visible before battle and announce themselves with the cartridge's own animation and sound. |
