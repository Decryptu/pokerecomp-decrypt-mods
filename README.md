...
| --- | --- | --- | --- |
| <img src="docs/icons/voxel3d.png" alt="" width="64" height="64"> | [`voxel3d`](mods/voxel3d/) | 0.4.0 | The overworld as a voxel diorama, textured from the cartridge's own tileset and drawn at the window's resolution, with the ground carrying on past the mesh so the maps around this one stand where the connection graph puts them, and the fight staged on the map it started on with a steerable over-the-shoulder camera. One switch on its page turns it on for both. |
...
| <img src="docs/icons/overworld_encounters.png" alt="" width="64" height="64"> | [`overworld_encounters`](mods/overworld_encounters/) | 0.2.0 | A bounded population of wild Pokemon roaming where random grass, cave and surf encounters used to be. Shiny Pokemon are visible before battle and announce themselves with the cartridge's own animation and sound. |
