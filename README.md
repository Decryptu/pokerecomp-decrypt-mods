...
| [`randomizer`](mods/randomizer/) | 0.2.0 | A save-bound run generated from a four-digit seed: wild encounters, gifts, static Pokemon, species, moves and trainer teams. The same seed and settings on the same cartridge produce the same run. |
