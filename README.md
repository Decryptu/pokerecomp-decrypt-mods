...
| --- | --- | --- |
| [`voxel3d`](mods/voxel3d/) | 0.3.12 | The overworld as a voxel diorama, textured from the cartridge's own tileset and drawn at the window's resolution, and the fight staged on the map it started on with a steerable over-the-shoulder camera. One switch on its page turns it on for both. |
