...
const TILESETS: Dictionary = {
	0: {
		&"bush": [64, 65, 80, 81],
		&"facade": [
			4, 5, 6, 7, 8, 9, 10, 11, 12, 21, 22, 23, 24, 25, 26, 27, 28, 34, 47, 63,
			66, 67, 68, 69, 74, 75, 76, 77, 78, 79, 90, 91, 92, 93,
		],
		&"fence": [14, 85],
	...
	10: {
		...
		&"counter": [23, 24],
		&"ground": [4, 20],
		&"stand": [5, 6, 21, 22, 37, 38, 53, 54, 76, 77, 92, 93],
		&"stool": [2, 3, 18, 19],
		&"wall": [72, 74, 78, 79],
	},
	11: {
	...
	12: {
		...
		&"desk": [34, 35],
		&"ground": [4, 20],
		&"stand": [5, 6, 14, 15, 21, 22, 30, 31, 36, 37, 38, 52, 53, 54, 57],
		&"stool": [2, 3, 18, 19],
